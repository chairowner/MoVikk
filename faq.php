            ...
            <div class="container">
                <div class="w-100 d-flex justify-content-between flex-wrap" style="gap:40px;">
                    ...
                    <div class="quest-icon">
                        ...
                        <a class="d-flex justify-content-center align-items-center flex-wrap" style="gap:10px;" target="_blank" href="<?=$COMPANY->socials['vk']['href']?>">
                            <img class="social-icon" src="/assets/icons/social-vk.svg" alt="ВКонтакте">
                            <?=$COMPANY->socials['vk']['title']?>
                        </a>
                        <a class="d-flex justify-content-center align-items-center flex-wrap" style="gap:10px;" target="_blank" href="<?=$COMPANY->socials['instagram']['href']?>">
                            <img class="social-icon" src="/assets/icons/social-instagram.svg" alt="Инстаграм">
                            <?=$COMPANY->socials['instagram']['title']?>
                        </a>
                    </div>
                </div>
            </div>
